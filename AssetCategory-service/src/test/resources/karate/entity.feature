...
Feature: Check AssetCategory Entity Rest Api Response

  Scenario: AssetCategory Entity CRUD Operations
    ...
    And request
    """ {
      "name": "Test Category Entity Feature"
    } """
    # ---------------------------------
    When method POST
    Then status 200
    ...
    * def entityId = response.id
    ...
    """ {
          "id":"#(entityId)",
          "entityVersion":1,
          "name": "Test Category Entity Feature Updated"
    }
    """
    # ---------------------------------
    When method PUT

...
import it.water.assetcategory.service.AssetCategoryApplication;

@SpringBootTest(classes = AssetCategoryApplication.class,
...
public class AssetCategoryRestSpringApiTest {
    ...
    Karate restInterfaceTest() {
        return Karate.run("../AssetCategory-service/src/test/resources/karate")
